...
E solicito um novo cadastro para o <email> 
...
|'paula_rhguby@guts.com'   | 'masc' | 'Paula'    | 'Silba'   | '12369578'  | '10' | 'March' | '1980'  |  'no'      | 'ABCnow' | 'Rua 3, lote 54' | 'Rio de Janeiro' | '59632' | 'Iowa' | '5551566852242' | 'Casa'       |
|'paula_rubhgy_l@guts.com' | 'fem ' | 'Marina'   | 'Silva'   | '12359578'  | '13' | 'March' | '1981'  |  'yes'     | 'ABCnaw' | 'Rua 2, lote 52' | 'São Paulo'      | '56852' | 'Iowa' | '5555668546242' | 'Casa'       |
